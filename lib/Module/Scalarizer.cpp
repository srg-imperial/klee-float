...
// FIXME: This is taken from r195471 in LLVM. This unfortunately
// was introduced just after LLVM branched for 3.4 so it has been
// copied into KLEE's source tree. I have no idea if this builds
// with LLVM 2.9. It probably doesn't!
